...
const Footer = () => {
    return (
        <div className="flex flex-col items-center mt-8">
            <p className="text-lg font-semibold">Stay Connect with Me</p>
            <div className="flex gap-4 mt-4 mb-4">
                <a className='text-gray-600 bg-gray-50 p-2 rounded-full w-12 h-12 flex items-center justify-center hover:bg-yellow-500 hover:text-white transition-colors' href='/'>
