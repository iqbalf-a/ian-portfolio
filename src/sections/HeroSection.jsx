        ...
        <div className="block md:flex px-12 md:px-48 w-full justify-between items-center bg-gradient-to-r from-cyan-50 to-blue-50 md:mt-6 mt-16 pt-4">
            <div className="flex-1 py-4 md:py-6">
                ...
                <div className="flex items-center mt-8 gap-8">
                    <a href="https://github.com/iqbalf-a" className="flex gap-2 px-4 md:px-8 py-2 md:py-4 bg-blue-500 rounded-lg text-white text-base font-semibold hover:bg-yellow-500 shadow-xl transition-colors">
